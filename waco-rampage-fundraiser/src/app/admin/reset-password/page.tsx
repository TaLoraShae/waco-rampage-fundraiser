...
export default function ResetPasswordPage() {
  ...
  useEffect(() => {
    // The reset link Supabase emails logs the browser into a temporary
    // "recovery" session automatically when this page loads. We just
    // need to wait for that to happen before showing the form.
