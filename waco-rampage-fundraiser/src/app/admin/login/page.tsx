...
export default function AdminLoginPage({
  ...
  return (
    <div className="min-h-screen bg-rampage-purple-deep flex items-center justify-center px-4">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-card p-8">
        <p className="text-xs uppercase tracking-widest text-rampage-purple font-semibold mb-1">
          {brand.teamName}
        </p>
        ...
        <div className="mt-6 rounded-xl bg-amber-50 border border-amber-200 text-amber-800 text-xs p-3 leading-relaxed">
