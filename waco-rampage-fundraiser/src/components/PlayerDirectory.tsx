    ...
    <div>
      <div className="mb-6 max-w-sm">
        ...
        <input
          ...
          className="w-full rounded-full border border-black/10 px-5 py-3 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-rampage-purple"
        />
      </div>

      {filtered.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-black/15 p-10 text-center text-rampage-gray">
